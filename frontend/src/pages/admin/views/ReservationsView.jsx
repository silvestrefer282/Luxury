...
const ReservationsView = ({ 
    ...
    const handlePrint = async (contract, res) => {
        try {
            await generateContractPDF(contract, res, logoB64);
        } catch (error) {
            console.error("Error generating PDF:", error);
            if (triggerAlert) {
                triggerAlert("Error de Generación", "Hubo un problema al materializar el documento PDF desde la lista. Intente de nuevo.");
            }
        }
    };
