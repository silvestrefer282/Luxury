    ...
    return (
        <PageTransition>
            <div className="bg-white min-h-screen">
                ...
                {/* Filter section */}
                <div className="sticky top-[88px] z-[400] bg-white/95 backdrop-blur-md border-y border-primary-100 py-8 mb-24 transition-all duration-300 shadow-sm sticky-submenu">
